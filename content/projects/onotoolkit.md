...
- IndexedDB
- Cloudflare Workers
problemSolved: Heavy utilities (PDF compression, image background removal, video editing,
  JWT debugging) typically require uploading sensitive user files and secrets to third-party
  cloud servers, posing privacy and data leak risks.
architecture:
...
Privacy-first suite of high-performance browser utilities running entirely in the user browser.
